...
<font size="4" ><a href="mainmenu.php" data-icon="back" data-role="button" data-theme="a">ลองอีกครั้ง</a></font>
<?
}
else
{
...
?>
	...
	<div style="padding-left:10px;padding-right:10px">
      ...
      <img src="pic/welcome1.png" width="240" height="120"> </div>
		...
		<font size="4" color="#990000"><a href="mainemployee.php" data-icon="grid" data-role="button" data-theme="a">เข้าสู่เมนูหลัก</a></font>
    </div>    
